...
class BudgetType(models.TextChoices):
    ...
    ORGANIZATION = "99", 'Доход организации (только дляПДИ)'
    __empty__ = '(Unknown)'


class Budget(models.Model):
    # guid = models.CharField("Глобально-уникальный
    # идентификатор записи", max_length=36) # ! Не берем при импорте
...
class GlavBudgetClass(models.Model):
    ...
    # кода", blank=False, null=False, default=datetime.datetime.now)
